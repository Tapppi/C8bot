...
*And I want my fuckin multiline string literals. So I hardcoded this file to hold some premium 100% certified not-stolen haikus.
*
*/

export default class HaikusModel {

    randomHaiku(){
        let randIndex = Math.floor(Math.random() * this.haikus.length +1);
        return this.haikus[randIndex];
    }
